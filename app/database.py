...
def get_engine(database_url: str = settings.DATABASE_URL):
    ...
    try:
        ...
        engine = create_engine(database_url, echo=True) # echo=True enables logging of all SQL statements generated by SQLAlchemy, which is helpful for debugging and learning how SQLAlchemy interacts with the database
        return engine
